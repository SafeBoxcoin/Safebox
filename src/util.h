...
extern const char * const SBX_CONF_FILENAME;
extern const char * const SBX_PID_FILENAME;
extern const char * const SBX_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("safebox-%s", name);

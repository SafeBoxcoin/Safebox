...
#include "qt/safebox/furabstractlistitemdelegate.h"
#include "qt/safebox/txviewholder.h"
#include "qt/safebox/tooltipmenu.h"
#include "qt/safebox/sendmultirow.h"
#include "qt/safebox/coldstakingmodel.h"
#include "qt/safebox/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(SBXGUI* parent);
    ~ColdStakingWidget();

...
#include "qt/safebox/forms/ui_coldstakingwidget.h"
#include "qt/safebox/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/safebox/requestdialog.h"
#include "qt/safebox/tooltipmenu.h"
#include "qt/safebox/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(SBXGUI* parent) :
    PWidget(parent),

...
#include "config/safebox-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    QList<qreal> valuesSbx;
    //QList<qreal> valueszSbx;
...
public:
    explicit DashboardWidget(SBXGUI* _window);
    ~DashboardWidget();

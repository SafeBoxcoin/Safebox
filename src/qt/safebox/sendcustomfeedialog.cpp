...
#include "qt/safebox/sendcustomfeedialog.h"
#include "qt/safebox/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(SBXGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &SBXGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);

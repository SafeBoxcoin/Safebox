...
#include "qt/safebox/forms/ui_masternodeswidget.h"

#include "qt/safebox/qtutils.h"
#include "qt/safebox/mnrow.h"
#include "qt/safebox/mninfodialog.h"
#include "qt/safebox/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(SBXGUI *parent) :
    PWidget(parent),

...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, SBXGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, SBXGUI* gui, double posX = 3);

...
#include "qt/safebox/topbar.h"
#include "qt/safebox/forms/ui_topbar.h"
#include "qt/safebox/lockunlock.h"
#include "qt/safebox/qtutils.h"
#include "qt/safebox/receivedialog.h"
#include "qt/safebox/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/safebox/balancebubble.h"
...
TopBar::TopBar(SBXGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopSbx, ui->labelAmountTopShieldedSbx}, "amount-small-topbar");
    setCssProperty({ui->labelAmountSbx}, "amount-topbar");
    setCssProperty({ui->labelPendingSbx, ui->labelImmatureSbx}, "amount-small-topbar");
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // SBX Total
    QString totalSbx = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // SBX
    // Top
    ui->labelAmountTopSbx->setText(totalTransparent);
    ui->labelAmountTopShieldedSbx->setText(totalShielded);
    // Expanded
    ui->labelAmountSbx->setText(totalSbx);
    ui->labelPendingSbx->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureSbx->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}

...
#include "qt/safebox/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/safebox/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(SBXGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to SBXGUI::handleRestart()

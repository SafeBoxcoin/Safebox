...
#include "qt/safebox/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/safebox/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(SBXGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(CMD_REPLY, (tr("Welcome to the SBX RPC console.") + "<br>" +

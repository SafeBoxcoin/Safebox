...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            SBXGUI* window = static_cast<SBXGUI*>(parentWidget());
...
{
    SBXGUI* gui = static_cast<SBXGUI*>(parentWidget());
...
{
    hide();
    static_cast<SBXGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("SBX will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your SBXs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +

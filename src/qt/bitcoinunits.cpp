...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(SBX);
    unitlist.append(mSBX);
    unitlist.append(uSBX);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    ...
    case mSBX:
        return QString("msbx");
    case uSBX:
        return QString::fromUtf8("usbx");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZsbx)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZSBX)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZSBX);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZSBX)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZSBX));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}

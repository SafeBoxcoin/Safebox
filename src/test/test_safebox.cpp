...
#define BOOST_TEST_MODULE Sbx Test Suite

#include "test/test_sbx.h"
...
{
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_sbx_%lu_%i", (unsigned long)GetTime(), (int)(InsecureRandRange(100000)));

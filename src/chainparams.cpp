...
{
    const char* pszTimestamp = "Started in late 2022";
...
static Checkpoints::MapCheckpoints mapCheckpoints = {
    {0, uint256S("00000f90f9783baa2b9dabb9f7c2a3e6cb3ddb8889c82e8ff138b70cd4378b57")}
};
...
*/
        ...
        genesis = CreateGenesisBlock(1656793447, 804552, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256("00000f90f9783baa2b9dabb9f7c2a3e6cb3ddb8889c82e8ff138b70cd4378b57"));
        assert(genesis.hashMerkleRoot == uint256("c1ec0066fbdf5a600367dc8d87f443f2bf65f34bcec2436ce5ba71ba95ce1dd2"));

        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // SBX starting difficulty is 1 / 2^12
        ...
        consensus.nMaxMoneyOut = 445545598 * COIN;
        ...
        // validation by-pass
        consensus.nSbxBadBlockTime = 1471401614;    // Skip nBit validation of Block 259201 per PR #915
        consensus.nSbxBadBlockBits = 0x1c056dac;    // Skip nBit validation of Block 259201 per PR #915
        ...
        consensus.ZC_MinStakeDepth = 400;
        ...
        vSeeds.emplace_back("1", "138.124.180.48", true); 
        vSeeds.emplace_back("2", "176.126.113.64", true); 
        vSeeds.emplace_back("3", "45.8.147.125", true); 
        vSeeds.emplace_back("4", "94.131.110.59", true); 
        vSeeds.emplace_back("5", "45.156.24.147", true); 
        vSeeds.emplace_back("6", "45.156.24.190", true); 
        vSeeds.emplace_back("7", "45.156.24.191", true); 
        vSeeds.emplace_back("8", "45.156.24.245", true); 


        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 125); // starting with 's'
        ...
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "safeks";
...
public:
    CTestNetParams()
    {
        ...
        //vSeeds.emplace_back("fuzzbawls.pw", "safebox-testnet.seed2.fuzzbawls.pw", true);

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet safebox addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet safebox script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet safebox BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = {0x3a, 0x80, 0x61, 0xa0};
        // Testnet safebox BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = {0x3a, 0x80, 0x58, 0x37};
        // Testnet safebox BIP44 coin type is '1' (All coin's testnet default)
        ...
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "safeboxktestsapling";

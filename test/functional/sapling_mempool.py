#!/usr/bin/env python3
# Copyright (c) 2020 The SafeBox Core developers
...
class SaplingMempoolTest(SbxTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 SBX note to Alice
        ...
        # miner sends another 10 SBX note to Alice

...
from test_framework.test_framework import SbxTier2TestFramework
...
class MasternodeGovernanceBasicTest(SbxTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.safebox.org/t/test-proposal"

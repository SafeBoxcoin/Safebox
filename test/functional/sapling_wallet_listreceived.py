...
class ListReceivedTest (SbxTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 SBX.
        ...
        # Send 1 SBX to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 SBX sending them all (fee is 0.1 SBX)
        ...
        # Confirm transaction (2 SBX from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 SBX, send 0.6 SBX + 0.05 SBX fee
